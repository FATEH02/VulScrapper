...
genai.configure(api_key="generate you api key ")#generate yoy api key and past here
...
def create_pdf(filename, severity_labels, severity_values, date_group):
    ...
    fig_pie.write_image("severity_distribution.png")  # Save image to use in PDF
    plt.close()
...
st.sidebar.header("Filter Vulnerabilities")
